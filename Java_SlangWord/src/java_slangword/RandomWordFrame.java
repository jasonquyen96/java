 ...
 * @author Admin
 */
public class RandomWordFrame extends javax.swing.JFrame {
     ...
     */
    public RandomWordFrame() {
        initComponents();
        ext = SlangExtension.getInstance();
        jtxtSlang.setEditable(false);
        jtxtMeaning.setEditable(false);
        jNextActionPerformed(null);
    }
    ...
    private void initComponents() {
        ...
        jlblTitle.setText("RANDOM SLANG WORD");
    ...
    private void jNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jNextActionPerformed
        ...
        String s[] = ext.random();
        jtxtSlang.setText(s[0]);
        jtxtMeaning.setText(s[1]);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RandomWordFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RandomWordFrame().setVisible(true);
            }
        });
    }
